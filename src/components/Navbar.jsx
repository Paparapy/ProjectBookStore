      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-xl font-bold text-blue-400 cursor-pointer">Thierry.Dev</a>
          </div>
          ...
          <div className="space-x-3 navbar-end">
            ...
            <div className="">
              <a
                className="p-2 px-3 text-white duration-300 bg-black rounded-md cursor-pointer hover:bg-slate-800"
                onClick={() =>
